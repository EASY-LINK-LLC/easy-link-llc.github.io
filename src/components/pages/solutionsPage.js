            ...
            <Card shadow>
              <Card.Content>
                ...
                <Text p>
                  ...
                  over 6 Tbps of bandwidth, 16 pops globally, and a dense server network covering 5 continents. We
                  enable CDN providers to provide digital assets of any type, size, or complexity, from static
                  information to live video.
                </Text>
              </Card.Content>
              <Card.Footer>
          ...
          <Grid xs>
            <Card shadow>
              <Card.Content>
                ...
                <Text p>
                  Our network works with a strong bandwidth reserve to provide smooth and reliable conversations at
                  scale, reducing congestion, excessive latency, and jitter, the major enemies of successful VoIP
                  installations.
                </Text>
              </Card.Content>
              <Card.Footer>
